...
void CAESDlg::OnButton1() 
{
	CRijndael Cr;
	CString filein, fileout;
	Cr.Initialize("124", 32, Cr.sm_chain0, 16, 16, 0, 0);
	Cr.EncryptFile("E:\\FoxitReader21_setup.rar","E:\\1");
	AfxMessageBox("D:\KumSung Book\Computer\1.pdf : Successfully Encrypted!");
}
...
void CAESDlg::OnButton2() 
{
	...
	CRijndael Cr;
	Cr.Initialize("124", 32, Cr.sm_chain0, 16, 16, 0, 0);
	Cr.DecryptFile("E:\\1","D:\\1.rar");
	AfxMessageBox("D:\R.txt : Successfully Decrypted!");
}
